...
class ShearScreenToDraft extends GetView<BondController> {
  final FilterBond filterBond;
  final Function(BondModel) onApprove;
  ...
  Widget _layout_descktop() {
    return FuturePaginationTableWidget(
      ...
      columns: [
        ...
        DataColumn(label: Text("اعتماد سند")),
      ],
      buildRow: (data, index) {
        return DataRow(
          ...
          cells: [
            ...
            DataCell(
              Text(
                data.bondTypeId == TransactionTypeEnum.credit.id
                    ? "سحب"
                    : "ايداع",
              ),
            ),
