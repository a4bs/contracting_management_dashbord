...
class BoundCreaditScreen extends GetView<BondController> {
  BoundCreaditScreen({super.key});
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            children: [
              Text("اضافة سند إيداع", style: TextStyle(fontSize: 20)),
              SizedBox(height: 10),
              Row(
                children: [
                  Expanded(
                          ...
                          Dialog(
                            child: FilterBondDilog(
                              onFilterSubmit: (data) async {
                                controller.filterBondToCredit.value =
                              ...
                              filterBond: controller.filterBondToCredit.value,
                            ),
                          ),
                        );
                      },
